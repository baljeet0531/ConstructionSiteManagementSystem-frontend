...
import { ShowPasswordIcon, SearchIcon } from "../../../Icons/Icons";

export default function AddRole(props: { setShowPopup: Function }) {
        ...
        <Center position={"absolute"} top={0} left={0} w={"100vw"} h={"100vh"} bg={"#D9D9D980"} zIndex={2}>
            <Center border={"1px solid #667080"} w={"32%"} borderRadius={"10px"} bg={"#FFFFFF"} p={"30px 45px"}>
                <Flex h={"100%"} direction={"column"} color={"#667080"}>
                    <Text fontWeight={700} fontSize={"20px"} lineHeight={"20px"}>新增人員</Text>
                    <Flex direction={"column"} mt={"20px"} rowGap={"20px"} bg={"#E3ECFF"} borderRadius={"10px"} p={"41px 20px"}>
                        <Flex justify={"flex-start"} h="36px">
                            <Text width={"35%"} fontWeight={"400"} fontSize={"14px"} lineHeight={"20px"} p="8px 12px">姓名</Text>
                            <InputGroup width={"60%"}>
                        ...
                        <Flex justify={"flex-start"} h="36px">
                            <Text width={"35%"} fontWeight={"400"} fontSize={"14px"} lineHeight={"20px"} p="8px 12px">職稱</Text>
                            <Select width={"60%"} variant='outline' bg={"#FFFFFF"}>
                        ...
                        <Flex justify={"flex-start"} h="36px">
                            <Text width={"35%"} fontWeight={"400"} fontSize={"14px"} lineHeight={"20px"} p="8px 12px">帳號</Text>
                            <Input width={"60%"} variant='outline' bg={"#FFFFFF"} type={"text"}></Input>
                        </Flex>
                        <Flex justify={"flex-start"} h="36px">
                            <Text width={"35%"} fontWeight={"400"} fontSize={"14px"} lineHeight={"20px"} p="8px 12px">密碼</Text>
                            <InputGroup width={"60%"}>
                                <Input type={show ? "text" : "password"} variant='outline' bg={"#FFFFFF"} ref={password} ></Input>
                                <InputRightElement>
                                    <IconButton
                        ...
                        <Flex justify={"flex-start"} h="36px">
                            <Text width={"35%"} fontWeight={"400"} fontSize={"14px"} lineHeight={"20px"} p="8px 12px">再輸入</Text>
                            <InputGroup width={"60%"}>
                                <Input type={showAgain ? "text" : "password"} variant='outline' bg={"#FFFFFF"} ref={passwordAgain} ></Input>
                                <InputRightElement>
                                    <IconButton
                                        aria-label='Show Password'
                                        icon={<ShowPasswordIcon />}
